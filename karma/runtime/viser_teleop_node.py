...
Session YAML example::
    ...
    - type: ViserTeleopNode
      name: viser_teleop
      agent_class: karma.agents.teleoperation.yam_pyroki_viser_agent:YamPyrokiViserAgent
      agent_kwargs:
        viser_port: 8765
        ik_rate: 100.0
      arm_key: left
