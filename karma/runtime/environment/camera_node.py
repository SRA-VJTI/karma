...
from karma.sensors.cameras.camera import CameraData, CameraDriver


_CAMERA_DRIVER_REGISTRY: dict[str, str] = {
    "ZedCamera":        "karma.sensors.cameras.zed_camera:ZedCamera",
    "OpenCVCamera":     "karma.sensors.cameras.opencv_camera:OpenCVCamera",
    "RealSenseCamera":  "karma.sensors.cameras.realsense_camera:RealSenseCamera",
}
