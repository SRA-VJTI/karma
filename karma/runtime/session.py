...
from karma.runtime.node import Node, ProcessHost
from karma.runtime.transport.message_bus import MessageBus, DEFAULT_SUB_PORT
from karma.runtime.transport.serialization import unpack
...
class Session:
    ...
    def start(self) -> None:
        import tempfile
        self._log_dir = Path(tempfile.mkdtemp(prefix="karma_logs_"))
